...
import com.ensias.socialgraph.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.ensias.socialgraph.domain.Follow}.
 */
@RestController
@RequestMapping("/api")
public class FollowResource {
    ...
    private static final String ENTITY_NAME = "socialgraphFollow";
    ...
    public List<FollowDTO> searchFollows(@RequestParam String query) {
        log.debug("REST request to search Follows for query {}", query);
        return followService.search(query);
    }
}
