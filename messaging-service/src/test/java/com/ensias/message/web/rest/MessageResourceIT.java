...
import com.ensias.message.service.mapper.MessageMapper;
...
class MessageResourceIT {
    ...
    public static Message createEntity(EntityManager em) {
        Message message = new Message().messageContent(DEFAULT_MESSAGE_CONTENT);
        return message;
    }
    ...
    public static Message createUpdatedEntity(EntityManager em) {
        Message message = new Message().messageContent(UPDATED_MESSAGE_CONTENT);
        return message;
    }
    ...
    void putNewMessage() throws Exception {
        ...
        updatedMessage.messageContent(UPDATED_MESSAGE_CONTENT);
    ...
    void fullUpdateMessageWithPatch() throws Exception {
        ...
        partialUpdatedMessage.messageContent(UPDATED_MESSAGE_CONTENT);
