package com.ensias.message.web.rest;

import com.ensias.message.repository.MessageRepository;
import com.ensias.message.service.MessageService;
import com.ensias.message.service.dto.MessageDTO;
import com.ensias.message.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.ensias.message.domain.Message}.
 */
@RestController
@RequestMapping("/api")
public class MessageResource {
    ...
    private static final String ENTITY_NAME = "messageMessage";
